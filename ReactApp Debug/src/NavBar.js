...
const NavBa = () => {
  return (
    ...
    <Navbar.Brand href="/">Live-survey</Navbar.Brand>
    <Navbar.Toggle aria-controls="basic-navbar-nav" />
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="mr-auto">
        <Nav.Link href="/">Home</Nav.Link>
        <NavDropdown title="Ankety" id="Survey-menu">
          <NavDropdown.Item href="/create" tabIndex="-1" aria-disabled="true">Vytvořit anketu</NavDropdown.Item>
          <NavDropdown.Item href="/album" tabIndex="-1" aria-disabled="true">Prohlížet ankety</NavDropdown.Item>
          <NavDropdown.Divider />
